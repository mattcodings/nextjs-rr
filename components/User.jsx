const User = ({userNumber, person, num1, num2, num3, colors}) => {
  return (
    <div className="flex justify-center gap-x-8 mb-2 items-center bg-black p-2 w-[550px] rounded-2xl">
      ...
      <input type="text" tabIndex={userNumber} className="border p-2 rounded-2xl h-[45px] w-[45px] text-center" name={`rumbleNum${num1}`} placeholder="1"></input>
      <input type="text" tabIndex={41 - userNumber} className="border p-2 rounded-2xl h-[45px] w-[45px] text-center" name={`rumbleNum${num2}`} placeholder="2"></input>
      <input type="text" tabIndex={40 + userNumber} className="border p-2 rounded-2xl h-[45px] w-[45px] text-center" name={`rumbleNum${num3}`} placeholder="3"></input>
